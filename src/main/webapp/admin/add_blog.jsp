...
<head>
    ...
    <title>Luxury Hotel - Add Blog Post</title>
    ...
    <section class="dashboard">
        ...
        <div class="dashboard-content">
            ...
            <div class="form-container">
                <form action="${pageContext.request.contextPath}/admin/addBlog" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="videoUrl" name="videoUrl" class="form-control" placeholder="e.g., https://www.youtube.com/embed/VIDEO_ID">
